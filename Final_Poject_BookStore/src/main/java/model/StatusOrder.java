...
public enum StatusOrder {
    ...
    * Packing: Khi nhan vien xac nhan don hang va chuan bi don hang
    * Delivering: Sau khi nhan vien xac nhan don hang va chuyen don hang di
    * Delivered: Da giao hang
    * Cancelled: Da huy don hang
    * Completed: Khi khach hang xac nhan da giao hang
     */
    /*
    * Cart:
    *
